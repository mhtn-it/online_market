                  ...
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>{new Intl.NumberFormat('de-DE', {currency: 'EUR' }).format(this.state.totalDay)}đ</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                  ...
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>{new Intl.NumberFormat('de-DE', {currency: 'EUR' }).format(this.state.totalMonth)}đ</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                  ...
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>{new Intl.NumberFormat('de-DE', {currency: 'EUR' }).format(this.state.totalYear)}đ</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
