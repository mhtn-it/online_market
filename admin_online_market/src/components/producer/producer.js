      ...
      return (
        <div className="form-group">
          <div className="col-lg-offset-2 col-lg-10">
            <button
              onClick={() => this.props.addProducer(this.state.name)}
            ...
            <button
              disabled
              onClick={() =>
                this.props.updateProducer(this.state.id, this.state.name)
              }
              className="btn-custom"
            >
              Update
    ...
    return (
      <section id="main-content">
        <div className="row">
          <div className="col-lg-12">
            ...
            <ol className="breadcrumb">
              ...
              <li>
                <i className="fa fa-th-list" />Producer Manager
              </li>
            </ol>
          </div>
        </div>
        <div className="row">
          <div className="col-lg-12">
            <section className="panel">
              <header className="panel-heading">Danh sách Nhà sản xuất</header>
              <table className="table table-striped table-advance table-hover">
                <tbody>
                  ...
                  {this.props.producer.map((element, index) => {
                    return (
                      <tr>
                        <td>{element.name}</td>
                        <td>
        ...
        <div className="row">
          <div className="col-lg-12">
            <section className="panel">
              <header className="panel-heading">Thông tin Nhà sản xuất</header>
